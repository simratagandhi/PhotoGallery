...
function checkViewPort(){
    ...
    /*debug */ /* $('.debug-size').html('photosWidth = '
+photosWidth+' thumbnailContainerWidth = '
...
function positionThumbnails() {
    ...
    detectFancyboxLinks();
    //to match the width of the menu bar with thumbnail container
...
//for opening pics fancy box
function detectFancyboxLinks(){
    
    //for small screen devices - top open in separate tab
    //remove all instances of click events assigned previously
    $('a.fancybox').unbind('click.fb');
    
    //chek window width if<550, remove fancybox class and add target of blank
    if($(window).width() < 550){
